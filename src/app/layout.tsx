...
const b = process.env.NEXT_PUBLIC_BASE_PATH ?? "/clearfintest";
...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: `${b}/favicon_16x16.png`, sizes: "16x16", type: "image/png" },
      { url: `${b}/favicon_32x32.png`, sizes: "32x32", type: "image/png" },
      { url: `${b}/favicon_64x64.png`, sizes: "64x64", type: "image/png" },
    ],
  },
};
